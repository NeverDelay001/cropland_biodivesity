...
%     info=geotiffinfo('H:\landuse_biodiversity\Data\landuse_500m\landuse_500m_class\landuse_crop\landuse_500m_2001.tif');
    ...
    disp(annual)
    %folder=(['H:\landuse_biodiversity\Data\landuse_500m\landuse_500m_class\landuse_crop']);
    folder=(['H:\landuse_biodiversity\Data\landuse_500m\landuse_500m_10class_mask']);
    imgpath=strcat(folder,'\landuse_500m_',int2str(annual),'.tif');
...
%         img=int16(img);
    ...
    %folder2=(['H:\landuse_biodiversity\Data\landuse_500m\landuse_500m_crop\landsue_crop_10km']);
    folder2=(['H:\landuse_biodiversity\Data\landuse_500m\landuse_500m_10class_mask_all\landsue_10class_10km']);
